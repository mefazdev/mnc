   ...
   <Link href='/'>
    ...
    <div className='navbar__right  flex'>
        <div className='navbar__right__div flex'>
          ...
          <Link href='/'><h3 className={router.pathname == "/" ? "active__nav" : ""}>HOME</h3></Link>
      ...
      <ul className="dropdown-menu absolute hidden   group-hover:block  text-gray-700 pt-6">
                <span className="development__head cursor-pointer group">
                  <Link href='/About'>
                  <div 
                  className={router.pathname == "/About" ? "active__dropdown py-2" : "service__group__span py-2"}
                  >
                    <li className=" px-4 block whitespace-no-wrap text-sm ">
                      <p className={router.pathname == "/About" ? "active__dropdown" : ""}> JAMIA</p>
                   
                    </li>
              </div>
                  </Link>
                 <Link href='/Faculty'><div 
              className={router.pathname == "/Faculty" ? "active__dropdown py-2" : "service__group__span py-2"}
              >
                    <li className=" px-4 block whitespace-no-wrap text-sm ">
                     FACULTY PROFILE
                    </li>
      ...
      <ul className="dropdown-menu absolute hidden   group-hover:block  text-gray-700 pt-6">
                <span className="development__head cursor-pointer group">
                  ...
                  <div 
                  className={router.pathname == "/HsProgrammes" ? "active__dropdown py-2" : "service__group__span py-2"}
                  >
                    <li className=" px-4 block whitespace-no-wrap text-sm ">
                   HS PROGRAMMES
                    </li>
                  ...
                  <div 
                   className={router.pathname == "/BsProgrammes" ? "active__dropdown py-2" : "service__group__span py-2"}
                  >
                    <li className=" px-4 block whitespace-no-wrap text-sm ">
                     BS PROGRAMMES
                    </li>
      ...
      <ul className="dropdown-menu absolute hidden   group-hover:block  text-gray-700 pt-6">
                ...
                <Link href='/Blogs'>
                <div 
                    className={router.pathname == "/Blogs" ? "active__dropdown py-2" : "service__group__span py-2"}
                  >
                    <li className=" px-4 block whitespace-no-wrap text-sm ">
                     NEWS
                    </li>
              ...
              <div 
                className={router.pathname == "/Images" ? "active__dropdown py-2" : "service__group__span py-2"}
              >
                    <li className=" px-4 block whitespace-no-wrap text-sm ">
                     IMAGES
                    </li>
              ...
              <div
               className={router.pathname == "/Videos" ? "active__dropdown py-2" : "service__group__span py-2"}
               >
                    <li className=" px-4 block whitespace-no-wrap text-sm ">
                     VIDEOS
                    </li>
