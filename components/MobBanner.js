        ...
        <div className="main__banner__tex pb-5 pt-3">
          ...
          <div className="flex mt-3">
            <button
              ...
              className="text-white border border-white p-1 px-3 m-auto"
            >
              GET AN ADMISSION
            </button>
          </div>
          ...
          <div className="modal border-4 ">
            ...
            <div className="modal__main pt-4 pb-4">
              ...
              <div className="modal__btn lg:flex w-full">
                ...
                >
                  <button className="m-auto w-fit border hover:scale-105 hover:transition ease-linear duration-150 hover:border border-gray-300">
                    {" "}
                    JMN JUNIOR SCHOOL
                  </button>
                </a>
                ...
                >
                  <button className="m-auto w-fit border border-gray-200  hover:scale-105 hover:transition ease-linear duration-150 hover:border ">
                    {" "}
                    JMN SENIOR SCHOOL
                  </button>
                </a>
