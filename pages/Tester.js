      ...
      <div className="relative z-10 h-full flex items-center justify-center text-center px-4">
        <div className="max-w-4xl mx-auto text-white">
          <h2 className="text-4xl font-bold mb-3 leading-tight mt-20">
            ...
            ഫീസ് കാരണം <br/> <span className="text-[#dff69c]">ഓൺലൈൻ മദ്റസ പഠനം</span> <br/>  മുടങ്ങുന്നവർ ഉണ്ടോ?
            </span>
          </h2>
          ...
          {/* കൃത്യമായ മാതൃകയിൽ ഏറ്റവും മികച്ച മെന്റർമാരുടെ മേൽനോട്ടത്തിൽ
                  ...
                  വിഷമിക്കേണ്ട. ഞങ്ങളുമായി ബന്ധപ്പെടൂ.    </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a
              ...
              >
                ...
                <span className="text-lg">WhatsApp: <spann className='font-bold'>+91 884 808 3551</spann></span>
              </a>
           
          </div>
          <div className=" w-fit mx-auto grid grid-cols-2 gap-6 mt-10">
          <div className=" flex gap-3 items-center ">
          <div className="bg-white/10 h-8 w-8 rounded-full flex justify-center items-center"><FaBrain className="text-lg text-white"   />
            </div><p className="font-semibold font-montserrat capitalize text-[#dff69c]"> multiple intelligence <br/> tutoring system</p>
            </div>
            <div className="text-[#dff69c] flex gap-3 items-center ">
            <div className="bg-white/10 h-8 w-8 rounded-full flex justify-center items-center"><FaChalkboardTeacher className="text-lg text-white"/>
            </div><p className="font-semibold font-montserrat">Expert Teachers</p>
            </div>
            <div className="text-[#dff69c] flex gap-3 items-center ">
            <div className="bg-white/10 h-8 w-8 rounded-full flex justify-center items-center"><FaPersonCircleCheck className="text-lg text-white"   />
          </div>  <p className="font-semibold font-montserrat">Personlized Attention</p>
            </div>
            <div className="text-[#dff69c] flex gap-3 items-center ">
            <div className="bg-white/10 h-8 w-8 rounded-full flex justify-center items-center"><IoIosTime className="text-lg text-white"   /></div>
            <p className="font-semibold font-montserrat">Flexible Schedule</p>
            </div>
